...
## 仓库目录说明
retail-sql-analysis-demo/ <br> 
├── 00_init_data.ipynb # 数据初始化脚本：Excel 导入 SQLite 生成业务库 <br> 
├── notebooks/ # 8 个独立分析 Notebook（核心代码） <br> 
│ ├── 01_overview_agg.ipynb 全量业务指标统计 <br> 
│ ├── 02_prov_category_group.ipynb 省份 + 品类营收交叉分析 <br> 
